...
/*! 
   ...
   *
   *Metoda sortuje liste typu Ltab oraz przekazuje dane o do obserwatorow o
   *wykonaniu sortowania oraz czasie poczatkowym i koncowym sortowania.
   *
   *\param[in] A - Lista na ktorej wykonwana jest zadana operacja z pliku operacja.cpp
   *\param[in] l i p - l to poczatek listy a p to koniec
   */
